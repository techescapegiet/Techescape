...
const L2_BLANKS: Record<AcademicYear, Record<Department, SemanticBlank[]>> = {
    ...
    "2nd Year": {
        ...
        "csd": [
            ...
            { word: "ICON", hint: "Small visual sign." },
            { word: "GRID", hint: "Alignment utility." },
            { word: "UXUX", hint: "Experience study." },
            { word: "BRAND", hint: "Identity design." },
            { word: "LOGO", hint: "Symbol of company." },
            { word: "WEBUI", hint: "Online interface." },
            { word: "MOBILE", hint: "Handheld app design." },
            { word: "Figma", hint: "Design tool software." },
            { word: "Adobe", hint: "Design software suite." },
            { word: "Sketch", hint: "Vector design tool." },
            { word: "Vect", hint: "Math-based graphics." },
            { word: "Raster", hint: "Pixel-based graphics." },
            { word: "Layer", hint: "Design element level." },
            { word: "Group", hint: "Collection of layers." },
            { word: "Frame", hint: "Artboard in Figma." },
            { word: "Comp", hint: "Reusable element." },
            { word: "Proto", hint: "Clickable model." },
            { word: "Flow", hint: "User path in app." },
            { word: "Wire", hint: "Low-fi structure." },
            { word: "HiFi", hint: "High-fi design." },
            { word: "Asset", hint: "Design file resource." },
            { word: "Menu", hint: "Navigational list." },
            { word: "Card", hint: "Content container." },
            { word: "Modal", hint: "Pop-up window." },
            { word: "Alert", hint: "Notif dialog." },
            { word: "Input", hint: "Data entry field." },
            { word: "Form", hint: "Set of inputs." },
            { word: "Slide", hint: "Moving element." },
            { word: "Switch", hint: "Toggle control." },
            { word: "Radio", hint: "Option selector." },
            { word: "Check", hint: "Multi-selector." },
            { word: "Drop", hint: "Selection list." },
            { word: "Field", hint: "Text box area." },
            { word: "Label", hint: "Instruction text." },
            { word: "Hint", hint: "Helpful text." },
            { word: "Error", hint: "Validation failed text." },
            { word: "Theme", hint: "Global style setting." },
            { word: "Accent", hint: "Highlight color." },
            { word: "Primary", hint: "Main brand color." },
            { word: "Border", hint: "Edge of element." },
            { word: "Shadow", hint: "Shadow effect." },
            { word: "Corner", hint: "Edge rounding." },
            { word: "Space", hint: "Gap between parts." },
            { word: "Padding", hint: "Inner spacing." },
            { word: "Margin", hint: "Outer spacing." }
        ]
    },
    "3rd Year": {
        "cse": [
...
const L4_SIMPLE_POOL: Record<"C" | "Java" | "Python", CodeChallenge[]> = {
    "C": [
        ...
        { id: "c11", language: "C", title: "Infinite While", brokenCode: "", initialCode: "int i=0; while(i<5) { printf(\"%d\", i); }", solutionCode: "int i=0; while(i<5) { printf(\"%d\", i); i++; }", expectedOutput: "01234", errorHint: "Don't forget to increment the loop variable." },
        { id: "c12", language: "C", title: "Logic Error", brokenCode: "", initialCode: "if(x > 10 || x < 5) // check if x is between 5 and 10", solutionCode: "if(x >= 5 && x <= 10)", expectedOutput: "", errorHint: "Use AND (&&) for range checks." },
        { id: "c13", language: "C", title: "Pointer Assign", brokenCode: "", initialCode: "int x=10; int *p = x;", solutionCode: "int *p = &x;", expectedOutput: "", errorHint: "Pointers need addresses." },
        { id: "c14", language: "C", title: "String Literal", brokenCode: "", initialCode: "char *s = \"Hi\"; s[0] = 'h';", solutionCode: "char s[] = \"Hi\"; s[0] = 'h';", expectedOutput: "hi", errorHint: "String literals are read-only." },
        { id: "c15", language: "C", title: "Printf Arg", brokenCode: "", initialCode: "printf(\"Val is %d\");", solutionCode: "printf(\"Val is %d\", val);", expectedOutput: "", errorHint: "Mismatch in arguments." },
        { id: "c16", language: "C", title: "Scanf Float", brokenCode: "", initialCode: "scanf(\"%d\", &fval);", solutionCode: "scanf(\"%f\", &fval);", expectedOutput: "", errorHint: "Use %f for float." },
        { id: "c17", language: "C", title: "Array Init", brokenCode: "", initialCode: "int a[2] = {1, 2, 3};", solutionCode: "int a[3] = {1, 2, 3};", expectedOutput: "", errorHint: "Size mismatch." },
        { id: "c18", language: "C", title: "Void Read", brokenCode: "", initialCode: "void x; x = 10;", solutionCode: "int x; x = 10;", expectedOutput: "", errorHint: "void cannot be a variable type." },
        { id: "c19", language: "C", title: "Header Typo", brokenCode: "", initialCode: "#include <studio.h>", solutionCode: "#include <stdio.h>", expectedOutput: "", errorHint: "It is stdio (Standard I/O)." },
        { id: "c20", language: "C", title: "Math Error", brokenCode: "", initialCode: "int a = 10/0;", solutionCode: "int a = 10/1;", expectedOutput: "", errorHint: "Divide by zero!" },
        { id: "c21", language: "C", title: "Loop Index", brokenCode: "", initialCode: "for(int i=1; i<=5; i++) printf(\"%d\", a[i]); // size 5", solutionCode: "for(int i=0; i<5; i++)", expectedOutput: "", errorHint: "0-based indexing." },
        { id: "c22", language: "C", title: "Char Init", brokenCode: "", initialCode: "char c = \"A\";", solutionCode: "char c = 'A';", expectedOutput: "", errorHint: "Chars use single quotes." },
        { id: "c23", language: "C", title: "Main Args", brokenCode: "", initialCode: "int main(char args)", solutionCode: "int main(int argc, char *argv[])", expectedOutput: "", errorHint: "Incorrect main signature." },
        { id: "c24", language: "C", title: "If Semicolon", brokenCode: "", initialCode: "if(x==5); { x=10; }", solutionCode: "if(x==5) { x=10; }", expectedOutput: "", errorHint: "Stray semicolon." },
        { id: "c25", language: "C", title: "Else Without If", brokenCode: "", initialCode: "else { x=0; }", solutionCode: "if(cond) { ... } else { x=0; }", expectedOutput: "", errorHint: "Missing if." },
        { id: "c26", language: "C", title: "Struct Semicolon", brokenCode: "", initialCode: "struct S { int x }", solutionCode: "struct S { int x; };", expectedOutput: "", errorHint: "Struct needs semicolon." },
        { id: "c27", language: "C", title: "Nested Comment", brokenCode: "", initialCode: "/* /* hi */ */", solutionCode: "/* hi */", expectedOutput: "", errorHint: "C doesn't nest comments." },
        { id: "c28", language: "C", title: "Define Semicolon", brokenCode: "", initialCode: "#define MAX 10;", solutionCode: "#define MAX 10", expectedOutput: "", errorHint: "Macros don't need semicolons." },
        { id: "c29", language: "C", title: "Pointer Null", brokenCode: "", initialCode: "int *p = NULL; *p = 5;", solutionCode: "int x=5; p=&x; *p=5;", expectedOutput: "", errorHint: "NULL dereference." },
        { id: "c30", language: "C", title: "Const Change", brokenCode: "", initialCode: "const int x=5; x=6;", solutionCode: "int x=5; x=6;", expectedOutput: "", errorHint: "Const is read-only." },
        { id: "c31", language: "C", title: "Function Call", brokenCode: "", initialCode: "func;", solutionCode: "func();", expectedOutput: "", errorHint: "Use parentheses." },
        { id: "c32", language: "C", title: "Sizeof Typo", brokenCode: "", initialCode: "sizeof int", solutionCode: "sizeof(int)", expectedOutput: "", errorHint: "Needs parens for types." },
        { id: "c33", language: "C", title: "Enum Value", brokenCode: "", initialCode: "enum E {A=1, A=2};", solutionCode: "enum E {A=1, B=2};", expectedOutput: "", errorHint: "Duplicate enum constant." },
        { id: "c34", language: "C", title: "Case Default", brokenCode: "", initialCode: "case default:", solutionCode: "default:", expectedOutput: "", errorHint: "Just default:." },
        { id: "c35", language: "C", title: "Scanf String", brokenCode: "", initialCode: "scanf(\"%s\", &str[10]);", solutionCode: "scanf(\"%s\", str);", expectedOutput: "", errorHint: "Check your pointer." },
        { id: "c36", language: "C", title: "Malloc Size", brokenCode: "", initialCode: "int *p = malloc(10);", solutionCode: "int *p = malloc(10 * sizeof(int));", expectedOutput: "", errorHint: "Size in bytes." },
        { id: "c37", language: "C", title: "Free Twice", brokenCode: "", initialCode: "free(p); free(p);", solutionCode: "free(p); p=NULL;", expectedOutput: "", errorHint: "Double free error." },
        { id: "c38", language: "C", title: "Union Align", brokenCode: "", initialCode: "union U { int i, char c };", solutionCode: "union U { int i; char c; };", expectedOutput: "", errorHint: "Semicolons inside." },
        { id: "c39", language: "C", title: "Array Assign", brokenCode: "", initialCode: "int a[]={1}; int b[]=a;", solutionCode: "b[0]=a[0];", expectedOutput: "", errorHint: "No array assignment." },
        { id: "c40", language: "C", title: "Logical NOT", brokenCode: "", initialCode: "if(x NOT 10)", solutionCode: "if(x != 10)", expectedOutput: "", errorHint: "Use != for Not Equal." },
        { id: "c41", language: "C", title: "Return Void", brokenCode: "", initialCode: "int f() { return; }", solutionCode: "void f() { return; }", expectedOutput: "", errorHint: "Match return type." },
        { id: "c42", language: "C", title: "Stray Char", brokenCode: "", initialCode: "int x @ 5;", solutionCode: "int x = 5;", expectedOutput: "", errorHint: "@ is not valid." },
        { id: "c43", language: "C", title: "Extern Init", brokenCode: "", initialCode: "extern int x = 5;", solutionCode: "int x = 5;", expectedOutput: "", errorHint: "Extern can't init." },
        { id: "c44", language: "C", title: "Long Suffix", brokenCode: "", initialCode: "long x = 100Z;", solutionCode: "long x = 100L;", expectedOutput: "", errorHint: "L for long." },
        { id: "c45", language: "C", title: "Octal Error", brokenCode: "", initialCode: "int x = 091;", solutionCode: "int x = 91;", expectedOutput: "", errorHint: "Octal is 0-7." },
        { id: "c46", language: "C", title: "Bitwise Typo", brokenCode: "", initialCode: "x &&& y", solutionCode: "x && y", expectedOutput: "", errorHint: "Too many &." },
        { id: "c47", language: "C", title: "Label Colon", brokenCode: "", initialCode: "mylabel; printf(\"Hi\");", solutionCode: "mylabel: printf(\"Hi\");", expectedOutput: "", errorHint: "Label needs colon." },
        { id: "c48", language: "C", title: "Prototype", brokenCode: "", initialCode: "void f(int); int main() { f(); }", solutionCode: "f(10);", expectedOutput: "", errorHint: "Arg mismatch." },
        { id: "c49", language: "C", title: "Include Brackets", brokenCode: "", initialCode: "#include \"stdio.h\"", solutionCode: "#include <stdio.h>", expectedOutput: "", errorHint: "Use angle brackets." },
        { id: "c50", language: "C", title: "Printf Float Precision", brokenCode: "", initialCode: "printf(\"%.2d\", 3.14);", solutionCode: "printf(\"%.2f\", 3.14);", expectedOutput: "3.14", errorHint: "Use %f for float." }
    ],
    ...
    "Java": [
        ...
        { id: "j11", language: "Java", title: "Final Change", brokenCode: "", initialCode: "final int x = 5; x = 6;", solutionCode: "int x = 5; x = 6;", expectedOutput: "", errorHint: "final variables cannot be reassigned." },
        { id: "j12", language: "Java", title: "Boolean Typo", brokenCode: "", initialCode: "boolean b = 1;", solutionCode: "boolean b = true;", expectedOutput: "", errorHint: "Java boolean is true/false, not 0/1." },
        { id: "j13", language: "Java", title: "Scanner Import", brokenCode: "", initialCode: "Scanner s = new Scanner(System.in);", solutionCode: "import java.util.Scanner;\nScanner s = new Scanner(System.in);", expectedOutput: "", errorHint: "Need to import java.util.Scanner." },
        { id: "j14", language: "Java", title: "Method Param", brokenCode: "", initialCode: "void f(int x) {} f(5.0);", solutionCode: "f(5);", expectedOutput: "", errorHint: "Type mismatch in method call." },
        { id: "j15", language: "Java", title: "Array Length", brokenCode: "", initialCode: "int n = arr.length();", solutionCode: "int n = arr.length;", expectedOutput: "", errorHint: "Array length is a field, not a method." },
        { id: "j16", language: "Java", title: "String Length", brokenCode: "", initialCode: "int n = s.length;", solutionCode: "int n = s.length();", expectedOutput: "", errorHint: "String length is a method length()." },
        { id: "j17", language: "Java", title: "Private Access", brokenCode: "", initialCode: "class A { private int x; } A a = new A(); a.x = 5;", solutionCode: "public int x;", expectedOutput: "", errorHint: "Cannot access private field." },
        { id: "j18", language: "Java", title: "Static Block", brokenCode: "", initialCode: "static { int x=5 }", solutionCode: "static { int x=5; }", expectedOutput: "", errorHint: "Missing semicolon in static block." },
        { id: "j19", language: "Java", title: "Interface Body", brokenCode: "", initialCode: "interface I { void f() { } }", solutionCode: "interface I { void f(); }", expectedOutput: "", errorHint: "Interface methods (pre-Java 8) have no body." },
        { id: "j20", language: "Java", title: "Override Typo", brokenCode: "", initialCode: "@Overide", solutionCode: "@Override", expectedOutput: "", errorHint: "Typo in annotation." },
        { id: "j21", language: "Java", title: "Switch String", brokenCode: "", initialCode: "switch(s) { case 'a': } // s is String", solutionCode: "case \"a\":", expectedOutput: "", errorHint: "Use double quotes for Strings." },
        { id: "j22", language: "Java", title: "Catch Order", brokenCode: "", initialCode: "catch(Exception e) {} catch(IOException i) {}", solutionCode: "catch(IOException i) {} catch(Exception e) {}", expectedOutput: "", errorHint: "Catch specific exceptions before general ones." },
        { id: "j23", language: "Java", title: "Null Pointer", brokenCode: "", initialCode: "String s = null; s.length();", solutionCode: "if(s!=null) s.length();", expectedOutput: "", errorHint: "NullPointerException incoming." },
        { id: "j24", language: "Java", title: "Abstract Inst", brokenCode: "", initialCode: "abstract class A {} A a = new A();", solutionCode: "class B extends A {} B a = new B();", expectedOutput: "", errorHint: "Cannot instantiate abstract class." },
        { id: "j25", language: "Java", title: "Super Typo", brokenCode: "", initialCode: "super.main();", solutionCode: "super.method();", expectedOutput: "", errorHint: "Super call failed." },
        { id: "j26", language: "Java", title: "This Order", brokenCode: "", initialCode: "void f() { int x=5; this(x); }", solutionCode: "this(); // must be first", expectedOutput: "", errorHint: "this() call must be the first statement." },
        { id: "j27", language: "Java", title: "Package Typo", brokenCode: "", initialCode: "pachage com.test;", solutionCode: "package com.test;", expectedOutput: "", errorHint: "It is 'package'." },
        { id: "j28", language: "Java", title: "Main Args Typo", brokenCode: "String[] arg", initialCode: "public static void main(String[] arg)", solutionCode: "String[] args", expectedOutput: "", errorHint: "Typically args, but check usage." },
        { id: "j29", language: "Java", title: "Float Suffix", brokenCode: "", initialCode: "float f = 3.14;", solutionCode: "float f = 3.14f;", expectedOutput: "", errorHint: "Needs 'f' suffix for float literal." },
        { id: "j30", language: "Java", title: "Long Suffix", brokenCode: "", initialCode: "long l = 12345678910;", solutionCode: "long l = 12345678910L;", expectedOutput: "", errorHint: "Needs 'L' suffix for long literal." },
        { id: "j31", language: "Java", title: "Import Star", brokenCode: "", initialCode: "import java.util.*;", solutionCode: "import java.util.List;", expectedOutput: "", errorHint: "Minimize imports if possible." },
        { id: "j32", language: "Java", title: "Try Catch", brokenCode: "", initialCode: "try { } // missing catch", solutionCode: "try { } catch(Exception e) { }", expectedOutput: "", errorHint: "Try needs catch or finally." },
        { id: "j33", language: "Java", title: "Finally Return", brokenCode: "", initialCode: "finally { return 1; }", solutionCode: "// avoid returns in finally", expectedOutput: "", errorHint: "Be careful with returns in finally blocks." },
        { id: "j34", language: "Java", title: "Synchronized", brokenCode: "", initialCode: "public sync void f()", solutionCode: "public synchronized void f()", expectedOutput: "", errorHint: "Full keyword is synchronized." },
        { id: "j35", language: "Java", title: "Transient", brokenCode: "", initialCode: "transient int x;", solutionCode: "transient int x;", expectedOutput: "", errorHint: "Used for serialization exclusion." },
        { id: "j36", language: "Java", title: "Volatile", brokenCode: "", initialCode: "volatile int x = 0;", solutionCode: "volatile int x = 0;", expectedOutput: "", errorHint: "Ensures visibility across threads." },
        { id: "j37", language: "Java", title: "Continue Label", brokenCode: "", initialCode: "continue myloop;", solutionCode: "myloop: for(...) { continue myloop; }", expectedOutput: "", errorHint: "Label must exist." },
        { id: "j38", language: "Java", title: "InstanceOf", brokenCode: "", initialCode: "if(s instance of String)", solutionCode: "if(s instanceof String)", expectedOutput: "", errorHint: "It's one word: instanceof." },
        { id: "j39", language: "Java", title: "Assert", brokenCode: "", initialCode: "assert(x > 0)", solutionCode: "assert x > 0;", expectedOutput: "", errorHint: "No parens needed for assert statement." },
        { id: "j40", language: "Java", title: "Annotation", brokenCode: "", initialCode: "@interface MyAnno { }", solutionCode: "@interface MyAnno { }", expectedOutput: "", errorHint: "Defines an annotation type." },
        { id: "j41", language: "Java", title: "Generics", brokenCode: "", initialCode: "List<int> list;", solutionCode: "List<Integer> list;", expectedOutput: "", errorHint: "Generics need wrapper classes, not primitives." },
        { id: "j42", language: "Java", title: "Lambda", brokenCode: "", initialCode: "(x) -> x + 1", solutionCode: "x -> x + 1", expectedOutput: "", errorHint: "Check lambda syntax." },
        { id: "j43", language: "Java", title: "Stream", brokenCode: "", initialCode: "list.stream().filter(x -> x > 0)", solutionCode: "list.stream().filter(x -> x > 0).collect(Collectors.toList());", expectedOutput: "", errorHint: "Streams need terminal operations." },
        { id: "j44", language: "Java", title: "Optional", brokenCode: "", initialCode: "Optional.of(null);", solutionCode: "Optional.ofNullable(null);", expectedOutput: "", errorHint: "of() throws error on null." },
        { id: "j45", language: "Java", title: "Var Keyword", brokenCode: "", initialCode: "var x; x = 10;", solutionCode: "var x = 10;", expectedOutput: "", errorHint: "var needs immediate initialization." },
        { id: "j46", language: "Java", title: "Record", brokenCode: "", initialCode: "record R(int x) { }", solutionCode: "record R(int x) { }", expectedOutput: "", errorHint: "Modern Java record syntax." },
        { id: "j47", language: "Java", title: "Sealed Class", brokenCode: "", initialCode: "sealed class A permits B { }", solutionCode: "sealed class A permits B { }", expectedOutput: "", errorHint: "Permits specific subclasses." },
        { id: "j48", language: "Java", title: "Yield", brokenCode: "", initialCode: "yield 5;", solutionCode: "case 1 -> { yield 5; }", expectedOutput: "", errorHint: "Used in switch expressions." },
        { id: "j49", language: "Java", title: "Default Method", brokenCode: "", initialCode: "default void f() { }", solutionCode: "default void f() { }", expectedOutput: "", errorHint: "Allowed in interfaces." },
        { id: "j50", language: "Java", title: "Strictfp", brokenCode: "", initialCode: "strictfp class A { }", solutionCode: "strictfp class A { }", expectedOutput: "", errorHint: "Forces platform-independent float math." }
    ],
    ...
    "Python": [
        ...
        { id: "p11", language: "Python", title: "Missing Parentheses", brokenCode: "", initialCode: "print \"Hello\"", solutionCode: "print(\"Hello\")", expectedOutput: "Hello", errorHint: "In Python 3, print is a function." },
        { id: "p12", language: "Python", title: "Dictionary Key", brokenCode: "", initialCode: "d = {1: 'a'}; print(d[2])", solutionCode: "print(d.get(2, 'default'))", expectedOutput: "", errorHint: "KeyError: Key 2 not in dict." },
        { id: "p13", language: "Python", title: "Mutable Default", brokenCode: "", initialCode: "def f(l=[]): l.append(1); return l", solutionCode: "def f(l=None): if l is None: l=[]", expectedOutput: "", errorHint: "Avoid mutable default arguments." },
        { id: "p14", language: "Python", title: "Tuple Assign", brokenCode: "", initialCode: "t = (1, 2); t[0] = 3;", solutionCode: "t = [1, 2]; t[0] = 3;", expectedOutput: "", errorHint: "Tuples are immutable." },
        { id: "p15", language: "Python", title: "Set Index", brokenCode: "", initialCode: "s = {1, 2}; print(s[0])", solutionCode: "for x in s: print(x)", expectedOutput: "", errorHint: "Sets are unordered and non-indexable." },
        { id: "p16", language: "Python", title: "Except Typo", brokenCode: "", initialCode: "try: pass except Error: pass", solutionCode: "except Exception:", expectedOutput: "", errorHint: "Catch existing exceptions." },
        { id: "p17", language: "Python", title: "Module Import", brokenCode: "", initialCode: "import math; print(pi)", solutionCode: "math.pi", expectedOutput: "", errorHint: "Specify module prefix." },
        { id: "p18", language: "Python", title: "Class Init", brokenCode: "", initialCode: "class A: def init(self): pass", solutionCode: "def __init__(self):", expectedOutput: "", errorHint: "Constructor is __init__." },
        { id: "p19", language: "Python", title: "Super Call", brokenCode: "", initialCode: "super().init()", solutionCode: "super().__init__()", expectedOutput: "", errorHint: "Typo in super call." },
        { id: "p20", language: "Python", title: "Global Var", brokenCode: "", initialCode: "x=0; def f(): x+=1", solutionCode: "global x; x+=1", expectedOutput: "", errorHint: "Use global keyword to modify." },
        { id: "p21", language: "Python", title: "Nonlocal Var", brokenCode: "", initialCode: "def f(): x=0; def g(): x+=1", solutionCode: "nonlocal x; x+=1", expectedOutput: "", errorHint: "Use nonlocal in nested functions." },
        { id: "p22", language: "Python", title: "Is vs ==", brokenCode: "", initialCode: "if x is 10:", solutionCode: "if x == 10:", expectedOutput: "", errorHint: "Use == for value comparison." },
        { id: "p23", language: "Python", title: "Input Type", brokenCode: "", initialCode: "x = input(); y = x + 1", solutionCode: "y = int(x) + 1", expectedOutput: "", errorHint: "input() returns a string." },
        { id: "p24", language: "Python", title: "Slice Typo", brokenCode: "", initialCode: "s[1, 3]", solutionCode: "s[1:3]", expectedOutput: "", errorHint: "Use colon : for slices." },
        { id: "p25", language: "Python", title: "Len Function", brokenCode: "", initialCode: "s.len()", solutionCode: "len(s)", expectedOutput: "", errorHint: "Use global len() function." },
        { id: "p26", language: "Python", title: "List Sort", brokenCode: "", initialCode: "l = [2, 1].sort()", solutionCode: "l.sort(); # returns None", expectedOutput: "", errorHint: ".sort() modifies in-place and returns None." },
        { id: "p27", language: "Python", title: "Join Error", brokenCode: "", initialCode: "\"\".join(1, 2)", solutionCode: "\"\".join(['1', '2'])", expectedOutput: "", errorHint: "join() needs an iterable of strings." },
        { id: "p28", language: "Python", title: "F-String Typo", brokenCode: "", initialCode: "f\"x is {x}\"", solutionCode: "f\"x is {x}\"", expectedOutput: "", errorHint: "Check brace alignment." },
        { id: "p29", language: "Python", title: "Docstring", brokenCode: "", initialCode: "''' hi ''", solutionCode: "''' hi '''", expectedOutput: "", errorHint: "Match triple quotes." },
        { id: "p30", language: "Python", title: "Decorate", brokenCode: "", initialCode: "@mydec def f():", solutionCode: "@mydec\ndef f():", expectedOutput: "", errorHint: "Decorator on own line." },
        { id: "p31", language: "Python", title: "Lambda Syntax", brokenCode: "", initialCode: "lambda x: return x", solutionCode: "lambda x: x", expectedOutput: "", errorHint: "No return in lambda." },
        { id: "p32", language: "Python", title: "Generator", brokenCode: "", initialCode: "def g(): give 1", solutionCode: "yield 1", expectedOutput: "", errorHint: "Use yield for generators." },
        { id: "p33", language: "Python", title: "With Open", brokenCode: "", initialCode: "f = open('a.txt'); # forgot close", solutionCode: "with open('a.txt') as f:", expectedOutput: "", errorHint: "Use with-block for safety." },
        { id: "p34", language: "Python", title: "Import Typo", brokenCode: "", initialCode: "from math import *; # bad practice", solutionCode: "import math", expectedOutput: "", errorHint: "Prefer named imports." },
        { id: "p35", language: "Python", title: "Class Method", brokenCode: "", initialCode: "class A: @classmethod def f(self):", solutionCode: "def f(cls):", expectedOutput: "", errorHint: "Class methods use cls." },
        { id: "p36", language: "Python", title: "Static Method", brokenCode: "", initialCode: "@staticmethod def f(self):", solutionCode: "def f():", expectedOutput: "", errorHint: "No self in staticmethod." },
        { id: "p37", language: "Python", title: "Map Error", brokenCode: "", initialCode: "map(int, ['1', '2'])[0]", solutionCode: "list(map(int, ['1', '2']))[0]", expectedOutput: "", errorHint: "map returns an object, skip indexing." },
        { id: "p38", language: "Python", title: "Zip Error", brokenCode: "", initialCode: "zip(a, b).next()", solutionCode: "next(zip(a, b))", expectedOutput: "", errorHint: "Use global next() function." },
        { id: "p39", language: "Python", title: "Super Param", brokenCode: "", initialCode: "super(self, A)", solutionCode: "super(A, self)", expectedOutput: "", errorHint: "Order is Class, Instance." },
        { id: "p40", language: "Python", title: "Name Main", brokenCode: "", initialCode: "if name == 'main':", solutionCode: "if __name__ == '__main__':", expectedOutput: "", errorHint: "Use double underscores." },
        { id: "p41", language: "Python", title: "Kwargs Typo", brokenCode: "", initialCode: "def f(*args, *kwargs):", solutionCode: "def f(*args, **kwargs):", expectedOutput: "", errorHint: "Use double asterisk for kwargs." },
        { id: "p42", language: "Python", title: "Annotation Typo", brokenCode: "", initialCode: "def f(x: int) -> int", solutionCode: "def f(x: int) -> int:", expectedOutput: "", errorHint: "Missing colon after header." },
        { id: "p43", language: "Python", title: "Async Typo", brokenCode: "", initialCode: "asyn def f():", solutionCode: "async def f():", expectedOutput: "", errorHint: "Full word is async." },
        { id: "p44", language: "Python", title: "Await Error", brokenCode: "", initialCode: "await f(); # in sync func", solutionCode: "async def caller(): await f()", expectedOutput: "", errorHint: "Await only inside async." },
        { id: "p45", language: "Python", title: "None Compare", brokenCode: "", initialCode: "if x == None:", solutionCode: "if x is None:", expectedOutput: "", errorHint: "Idiomatic check is 'is None'." },
        { id: "p46", language: "Python", title: "List Pop", brokenCode: "", initialCode: "l.pop(100); # list size 5", solutionCode: "l.pop()", expectedOutput: "", errorHint: "Index out of range." },
        { id: "p47", language: "Python", title: "Set Union", brokenCode: "", initialCode: "s1 + s2", solutionCode: "s1 | s2", expectedOutput: "", errorHint: "Use | for set union." },
        { id: "p48", language: "Python", title: "Frozenset", brokenCode: "", initialCode: "fs = frozenset([1]); fs.add(2)", solutionCode: "fs = set([1]); fs.add(2)", expectedOutput: "", errorHint: "Frozensets are immutable." },
        { id: "p49", language: "Python", title: "Bool Cast", brokenCode: "", initialCode: "if bool('False'): # true", solutionCode: "if s == 'True':", expectedOutput: "", errorHint: "Any non-empty string is True." },
        { id: "p50", language: "Python", title: "Del Typo", brokenCode: "", initialCode: "delete x", solutionCode: "del x", expectedOutput: "", errorHint: "Keyword is del." }
    ]
